# 代码源自“better_zipfile”库（https://pypi.org/project/better-zipfile/  ， https://github.com/aplmikex/better_zipfile/blob/main/better_zipfile/fixcharset_zipfile.py），自己稍作修改。
# 可以有效防止解析压缩包时，以及解压时，文件名出现乱码，
